...
class UserLockTimeStamp
{
	...
	public function GetTime()
	{
		...
		$q_y= "select *  from users where email='$this->username' or nickname='$this->username'";
	...
	public function SetTime($day,$hour)
	{
		...
		$q= "update users set bantime='$locktime' where email='$this->username' or nickname='$this->username'";
	...
	public function SetReason($banreason){
                ...
                $q= "update users set banreason='$banreason' where email='$this->username' or nickname='$this->username'";
