<?php /* Smarty version Smarty-3.1.12, created on 2014-07-18 20:41:57
         compiled from "/www/yiya/templates/usersetting/infolist.tpl" */ ?>
<?php /*%%SmartyHeaderCode:116154675051effefc924e54-41172521%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7ca13ca06419fc28520d36448c314aba81a7f144' => 
    array (
      0 => '/www/yiya/templates/usersetting/infolist.tpl',
      1 => 1382497083,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '116154675051effefc924e54-41172521',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_51effefc9487b9_27667929',
  'variables' => 
  array (
    'y_nickname' => 0,
    'y_email' => 0,
...
<?php if ($_valid && !is_callable('content_51effefc9487b9_27667929')) {function content_51effefc9487b9_27667929($_smarty_tpl) {?><div>
	<form class="form-horizontal">
	<div id="inname" class="control-group">
		<label class="control-label">昵称：</label>
		<div class="controls"><input id="ininame" type="text" class="y-textbox" value=<?php echo $_smarty_tpl->tpl_vars['y_nickname']->value;?>
></input></div>
	</div>
	
	<div id="iemail" class="control-group">
		<label class="control-label">Email：</label>
		<div class="controls"><input id="iiemail" type="text"  class="y-textbox" value=<?php echo $_smarty_tpl->tpl_vars['y_email']->value;?>
></input></div>
	</div>
	
	<div id="aimgall" class="control-group">
		<label class="control-label">头像：</label>
		<div class="controls" style="width:150px"><img id="favatar" class="uavatar" src="<?php echo $_smarty_tpl->tpl_vars['apath']->value;?>
"/></div>
	</div>
	...
	<div id="iname" class="control-group">
		...
		<div class="controls"><input id="iiname" type="text" class="y-textbox" value=<?php echo $_smarty_tpl->tpl_vars['y_name']->value;?>
></input></div>
	</div>
	...
	<div id="isex" class="control-group">
		...
		<div class="controls">
			...
			<input id='sex' type='radio' name='sex' value='2' <?php echo $_smarty_tpl->tpl_vars['man_sex']->value;?>
></input>男
			</label>
			<label class="radio inline">
			<input id='sex' type='radio' name='sex' value='1' <?php echo $_smarty_tpl->tpl_vars['woman_sex']->value;?>
></input>女
			</label>
		</div>
	</div>
	...
	<div id="ilocation" class="control-group">
		...
		<div class="controls iallcity" id="iiallcity">
			<select id="iiprovince" class="prov " style="width:100px" data-val=<?php echo $_smarty_tpl->tpl_vars['y_province']->value;?>
></select>
			<select id="iicity" class="city " style="width:100px" disabled="disabled" data-val=<?php echo $_smarty_tpl->tpl_vars['y_city']->value;?>
></select>
		</div>
	</div>
	...
	<div id="iqq" class="control-group">
		...
		<div class="controls"><input id="iiqq" type="text" class="y-textbox" value=<?php echo $_smarty_tpl->tpl_vars['y_qq']->value;?>
></div>
	</div>
	
	<div id="iphone" class="control-group">
		<label class="control-label">电话：</label>
		<div class="controls"><input id="iiphone" type="text" class="y-textbox" value=<?php echo $_smarty_tpl->tpl_vars['y_tel']->value;?>
></input></div>
	</div>

	<div id="ibirth" class="control-group">
		<label class="control-label">生日：</label>
		<div class="controls"><input id="iibirth" type="text" class="y-textbox y-datepicker input-readonly" value=<?php echo $_smarty_tpl->tpl_vars['y_birthday']->value;?>
></div>
	</div>
